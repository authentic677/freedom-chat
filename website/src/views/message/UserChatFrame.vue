    ...
    methods:{
        ...
        async getData(){
            ...
            if(json.code===1){
                ...
                //设置对方用户名
                this.peerUsername=json.data[0].username2
                this.peerUid=json.data[0].uid2
